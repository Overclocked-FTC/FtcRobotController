...
@Autonomous(name = "Auto Red Right Med Junctions", preselectTeleOp = "TeleOp_Iterative")
public class AutoRedRightMedJunctions extends AutoBase {
    ...
    public void runOpMode() {
        ...
        Pose2d junctionM2 = new Pose2d(23+7.50, -22, Math.toRadians(180));
        Pose2d junctionM2V2 = new Pose2d(23+5.20, -22+4.00, Math.toRadians(225));
        Pose2d coneStack = new Pose2d(70.00-7.50, -12.25, Math.toRadians(0));
        Pose2d coneStackC2 = new Pose2d(70.00-7.50, -14.00, Math.toRadians(0));
        Pose2d signalZone1 = new Pose2d(11.75, -12.50, Math.toRadians(270));
        Pose2d signalZone2 = new Pose2d(35.25+2, -12.50, Math.toRadians(270));
        Pose2d signalZone3 = new Pose2d(60, -12.50, Math.toRadians(270));
        ...
        Trajectory trajJunctionM2C2FromStack = rr_drive.trajectoryBuilder(coneStackC2)
                .lineToLinearHeading(new Pose2d(23+5.20, -25+4.00, Math.toRadians(225)))
                .build();
        ...
        Trajectory trajSignalZone = rr_drive.trajectoryBuilder(junctionM2)
                .splineToLinearHeading(parkingZone, Math.toRadians(270))
                .build();

        Trajectory trajSignalZoneV2 = rr_drive.trajectoryBuilder(junctionM2V2)
